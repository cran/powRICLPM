...
The interpretation of the various performance measures available is explained in the function documentation [`?summary.powRICLPM()`](https://jeroendmulder.github.io/powRICLPM/reference/summary.powRICLPM.html). 
